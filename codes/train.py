...
def get_config():
    ...
    parser.add_argument("--episodes", type=int, default=5_000, help="Number of episodes, default: 200")
    ...
    parser.add_argument("--load_model", type=bool, default=False, help="Load a saved model to perform a test run!")
    parser.add_argument("--tau", type=float, default=5e-2, help="")
    parser.add_argument("--eval_every", type=int, default=100, help="")
    parser.add_argument("--device", type=str, default='cpu', help="Run on cpu or gpu")
